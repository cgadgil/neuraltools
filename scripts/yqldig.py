...
def getFinDataField(xmlDocument, dataFieldName):
    ...
    import pdb
    #pdb.set_trace()
    return {dataFieldName: getField(xmlDocument, dataFieldName).parent.parent.parent.contents[3].text}
...
def getFinData(xmlDocument, dataFieldName):
    ...
    if dataFieldName == "COMPANYNAME":
        ...
        try:
            ...
            #import pdb
            #pdb.set_trace()
            thePrice = xmlDocument.find(text="Price").parent.parent.parent.parent.parent.findAll("td")[8].text
            #print "HHHHHHHHHH" + str(thePrice[0].text.strip())
            thePrice = str(thePrice)
        except:
            thePrice = "0"
        ...
        try:
            ...
            theBeta = xmlDocument.find(text="Beta").parent.parent.parent.parent.parent.findAll("td")[26].text
        ...
        try:
            ...
            #import pdb
            #pdb.set_trace()
            theRange = xmlDocument.find(text="52-Wks-Range").parent.parent.parent.parent.parent.findAll("td")[31].text
